            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            Con años de experiencia en el sector, garantizamos
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            Nos comprometemos a brindar el mejor servicio al
                            cliente y superar tus expectativas.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-lg text-center">
                    ...
                    <p className="text-lg text-gray-600 mb-6">
                        Explora nuestras páginas para conocer más sobre nosotros
